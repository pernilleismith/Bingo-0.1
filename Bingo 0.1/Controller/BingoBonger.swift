...
class BingoBonger: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        i1.setTitle(numberArrayB.randomElement(), for: .normal)
        i2.setTitle(numberArrayB.randomElement(), for: .normal)
        i3.setTitle(numberArrayB.randomElement(), for: .normal)
        i4.setTitle(numberArrayB.randomElement(), for: .normal)
        i5.setTitle(numberArrayB.randomElement(), for: .normal)
        i6.setTitle(numberArrayB.randomElement(), for: .normal)
        i7.setTitle(numberArrayB.randomElement(), for: .normal)
        i8.setTitle(numberArrayB.randomElement(), for: .normal)
        i9.setTitle(numberArrayB.randomElement(), for: .normal)
        i10.setTitle(numberArrayB.randomElement(), for: .normal)
        i11.setTitle(numberArrayB.randomElement(), for: .normal)
        i12.setTitle(numberArrayB.randomElement(), for: .normal)
        i13.setTitle(numberArrayB.randomElement(), for: .normal)
        i14.setTitle(numberArrayB.randomElement(), for: .normal)
        i15.setTitle(numberArrayB.randomElement(), for: .normal)
        
        // Random number generator N
        n1.setTitle(numberArrayB.randomElement(), for: .normal)
        n2.setTitle(numberArrayB.randomElement(), for: .normal)
        n3.setTitle(numberArrayB.randomElement(), for: .normal)
        n4.setTitle(numberArrayB.randomElement(), for: .normal)
        n5.setTitle(numberArrayB.randomElement(), for: .normal)
        n6.setTitle(numberArrayB.randomElement(), for: .normal)
        n7.setTitle(numberArrayB.randomElement(), for: .normal)
        n8.setTitle(numberArrayB.randomElement(), for: .normal)
        n9.setTitle(numberArrayB.randomElement(), for: .normal)
        n10.setTitle(numberArrayB.randomElement(), for: .normal)
        n11.setTitle(numberArrayB.randomElement(), for: .normal)
        n12.setTitle(numberArrayB.randomElement(), for: .normal)
        n13.setTitle(numberArrayB.randomElement(), for: .normal)
        n14.setTitle(numberArrayB.randomElement(), for: .normal)
        n15.setTitle(numberArrayB.randomElement(), for: .normal)
        
        // Random number generator G
        g1.setTitle(numberArrayB.randomElement(), for: .normal)
        g2.setTitle(numberArrayB.randomElement(), for: .normal)
        g3.setTitle(numberArrayB.randomElement(), for: .normal)
        g4.setTitle(numberArrayB.randomElement(), for: .normal)
        g5.setTitle(numberArrayB.randomElement(), for: .normal)
        g6.setTitle(numberArrayB.randomElement(), for: .normal)
        g7.setTitle(numberArrayB.randomElement(), for: .normal)
        g8.setTitle(numberArrayB.randomElement(), for: .normal)
        g9.setTitle(numberArrayB.randomElement(), for: .normal)
        g10.setTitle(numberArrayB.randomElement(), for: .normal)
        g11.setTitle(numberArrayB.randomElement(), for: .normal)
        g12.setTitle(numberArrayB.randomElement(), for: .normal)
        g13.setTitle(numberArrayB.randomElement(), for: .normal)
        g14.setTitle(numberArrayB.randomElement(), for: .normal)
        g15.setTitle(numberArrayB.randomElement(), for: .normal)
        
        // Random number generator O
        o1.setTitle(numberArrayB.randomElement(), for: .normal)
        o2.setTitle(numberArrayB.randomElement(), for: .normal)
        o3.setTitle(numberArrayB.randomElement(), for: .normal)
        o4.setTitle(numberArrayB.randomElement(), for: .normal)
        o5.setTitle(numberArrayB.randomElement(), for: .normal)
        o6.setTitle(numberArrayB.randomElement(), for: .normal)
        o7.setTitle(numberArrayB.randomElement(), for: .normal)
        o8.setTitle(numberArrayB.randomElement(), for: .normal)
        o9.setTitle(numberArrayB.randomElement(), for: .normal)
        o10.setTitle(numberArrayB.randomElement(), for: .normal)
        o11.setTitle(numberArrayB.randomElement(), for: .normal)
        o12.setTitle(numberArrayB.randomElement(), for: .normal)
        o13.setTitle(numberArrayB.randomElement(), for: .normal)
        o14.setTitle(numberArrayB.randomElement(), for: .normal)
        o15.setTitle(numberArrayB.randomElement(), for: .normal)
